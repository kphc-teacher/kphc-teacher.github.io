...
*/
	...
	<body>
		...
		<div style="margin:100px auto 0;" id="wrapper">
			...
			<div id="msgsDialog" class="block">
				...
				<label class="options first"><input id="autoScroll" type="hidden" checked="checked" /></label>
				<label class="options"><input id="playSound" type="hidden" checked="checked" /></label>
